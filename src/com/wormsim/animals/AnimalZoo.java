 ...
 * @version 0.0.1
 */
public class AnimalZoo //				implements TrackedQuantity {
//	private static final Logger LOG = Logger.getLogger(AnimalZoo.class
//					.getName());
...
////			OldAnimalZoo.Builder zoo = new OldAnimalZoo.Builder();
////
...
//
//	/**
//	 * An implementation of the OldAnimalZoo that does not allow modification of
//	 * the animal strains and stages registered to it.
//	 *
