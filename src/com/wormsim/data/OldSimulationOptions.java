 ...
 * @author ah810
 * @version 0.0.1
 * @deprecated Use OldSimulationOptions instead.
 */
public class OldSimulationOptions implements Serializable {

	private static final Logger LOG = Logger.getLogger(OldSimulationOptions.class
					.getName());
	 ...
	 *                             file.
	 */
	public OldSimulationOptions(SimulationCommands cmds)
					throws IOException {
	...
	public void write(BufferedWriter out)
		...
		out.write("=");
		out.write(initial_conditions.toString());
		out.newLine();
